...
for vsize in ${vsizes[@]}; do
	...
	for csize in ${csizes[@]}; do
		BwWriteCorun $csize
		sleep 1
		BwReadVictimCorun $vsize ${viters[$index]}	
...
slowdown_file="figs/GTCOS-DoS-BW-Slowdown.dat"
missrate_file="figs/GTCOS-DoS-BW-LLCMiss.dat"
> $slowdown_file
> $missrate_file
